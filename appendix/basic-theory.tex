...
Factorization machines(FM) are a general-purpose supervised learning algorithm and where originally introduced by Steffen Rendle \cite{factorization_machines}.
