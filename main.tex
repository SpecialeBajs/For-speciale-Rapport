...
Throughout this paper we focus on three new methods for CF: LightGCN, Neural Graph collaborative Filtering (NGCF) and Price-aware Recommendation with Graph Convolutional Networks (PUP).
LightGCN is inspired from NGCF, and is a recommender system that only takes the node ID of items and users into account.
...
We also compare LightGCN to some other state-of-the-art methods and show that it performs significantly better than PUP, NGCF and other methods.
