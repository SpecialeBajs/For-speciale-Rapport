...
\\
An early model for CF is Matrix Factorization, which embeds user and item ID as vectors and and uses the dot product to predict whether a user would like a certain item.
