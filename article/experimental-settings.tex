...
For optimization Adam is used with an initial learning rate of $1e-2$
BPR is described in \autoref{subsubsec:BPR} and Adam is described in \autoref{subsubsec:Adam}.
The batch size is set to 1024.
For all test in \autoref{subsec:performance-com}, the number of convolutions are set to 3, except for PUP where the convolution is set to 1.
