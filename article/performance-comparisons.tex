...
When comparing the results with the experiment in \autoref{tab:results-with-many-methods} that used 3 convolutions for all methods except PUP, it can be seen that NGCF actually performs a bit worse for Recall@50 and NDCG@50.
